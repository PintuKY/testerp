...
class ManageDataOfProductOrderAndCustomerController extends Controller
{
                            ...
                            foreach ($lineItems as $lineItem) {
                                ...
                                foreach ($lineItems as $lineItem) {
                                    ...
                                    foreach ($metaData as $meta) {
                                        ...
                                        if ($meta->key != 'Delivery Days' && $meta->key != 'Time Slot' && $meta->key != 'Start Date') {
    ...
    public function createCustomer($customerId, $bussiness_location_id)
    {
        try {
            ...
            $customer = $this->getData($this->getConfiguration($bussiness_location_id), $customerEndpoint);
    ...
    public function createProduct($productId, $bussiness_location_id)
    {
        try {
            ...
            $product = $this->getData($this->getConfiguration($bussiness_location_id), $productEndpoint);
