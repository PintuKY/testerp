            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::file('business_logo', ['id' => 'business_logo','class'=>'form-control','required','accept' => 'image/*']); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('kitchen_location_id', __( 'business.kitchen_location_id' ) . ':*') !!}
                        {!! Form::select('kitchen_location_id',$kitchenlocation,null, ['class' => 'form-control', 'required','placeholder' => __( 'kitchen.select' )]); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('invoice_scheme_id', __('invoice.invoice_scheme') . ':*') !!} @show
                        _tooltip(__('tooltip.invoice_scheme'))
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('invoice_layout_id', __('lang_v1.invoice_layout_for_pos') . ':*') !!} @show
                        _tooltip(__('tooltip.invoice_layout'))
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('sale_invoice_layout_id', __('lang_v1.invoice_layout_for_sale') . ':*') !!} @show
                        _tooltip(__('lang_v1.invoice_layout_for_sale_tooltip'))
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('selling_price_group_id', __('lang_v1.default_selling_price_group') . ':') !!} @show
                        _tooltip(__('lang_v1.location_price_group_help'))
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        {!! Form::label('featured_products', __('lang_v1.pos_screen_featured_products') . ':') !!} @show
                        _tooltip(__('lang_v1.featured_products_help'))
                    ...
                    <div class="form-group">
                        <table class="table table-condensed table-striped">
                            ...
                            <tr>
                                ...
                                <th class="text-center @if(empty($accounts)) hide @endif">@lang('lang_v1.default_accounts') @show
                                    _tooltip(__('lang_v1.default_account_help'))
                                </th>
                            </tr>
                            </thead>
                            <tbody>
