...
<input type="hidden" value="{{$ingredient->id}}" name="menu[{{$ingredient->id}}][ingredient_id]" id="ingredient_id">
    ...
    <tr class="ing_row">
        ...
        <td>
            <div class="form-group">
                ...
                {!! Form::select('menu[' . $ingredient->id . '][measure_type]', ingredientMeasure(), null, ['placeholder' => 'Select Please', 'class' => 'form-control select2', 'style' => 'width:100%']); !!}
            </div>
        </td>
        <td>
            <div class="form-group">
                {!! Form::label('quantity', __( 'ingredient.quantity' ) . ':*') !!}
                {!! Form::text('menu[' . $ingredient->id . '][quantity]', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'ingredient.quantity' ) ]); !!}
            </div>
        </td>
    </tr>
    </tbody>
