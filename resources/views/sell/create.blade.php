	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid'])
				...
				<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-3 @endif">
					<div class="form-group">
						<label for="delivery_date">Start Date Or Delivery Date:*</label>
						<div class="input-group">
							<span class="input-group-addon">
								<i class="fa fa-calendar"></i>
							</span>
					...
					<div class="icheckbox_square-blue" style="position: relative;">
						...
						<div class="icheckbox_square-blue" style="position: relative;">
							...
							<div class="col-md-12 well well-sm bg-light-gray  hide ">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input class="form-control direct_sell_rp_input" data-amount_per_unit_point="1.0000" min="0" data-max_points="0" data-min_order_total="1.0000" name="rp_redeemed_modal" type="number" value="0" id="rp_redeemed_modal">
								...
								<div class="col-md-4">
									<p><strong>Redeemed Amount:</strong> (-)<span id="rp_redeemed_amount_text">$ 0.00</span></p>
								</div>
							</div>
							<div class="clearfix"></div>
