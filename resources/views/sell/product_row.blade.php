                ...
                <select class="form-control select_variation_value select2" required
                    ...
                    @foreach ($selected_variation as $key => $product_variation_name_data)
                        <option value="{{$product_variation_name_data->id}}"
                                data-price="{{$product_variation_name_data->default_sell_price}}"
                                data-products-variation-id="{{$productData->id}}">{{$product_variation_name_data->name}}
                            - {{$product_variation_name_data->default_sell_price}}</option>
                    @endforeach
                </select>
            </td>
            <td class="text-center v-center">
            ...
            <td>
                @foreach($selected_variation as $key => $product_variation_name_data)
                    <label class="radio-inline">
                        ...
                        - {{$product_variation_name_data->default_sell_price}}
                    </label><br>
                @endforeach
            </td>
            <td>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="box box-solid">
                            ...
                            <div class="form-group">
                                ...
                                @foreach(deliveryDays() as $key => $deliveryDays)
                                    <div class="icheckbox_square-blue" style="position: relative;">
                                        <input class="input-icheck" id="has_purchase_due" name="product[{{$product_id}}][has_purchase_due][]"
                        ...
                        <div class="@if(!empty($commission_agent)) col-sm-4 @else col-sm-4 @endif delivery_dates hide">
							...
							<span class="input-group-addon">
								<i class="fa fa-calendar"></i>
                                    ...
                                    {!! Form::text("product[" . $product_id . "][delivery_date]", $default_datetime, ['class' => 'form-control', 'required']); !!}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-body">
                        <div class="col-sm-6 time_slot hide">
                            <div class="form-group">
                                <label for="time_slot">Meal Type:*</label>
                                <div class="form-group">
                                    <select class="form-control select2" id="time_slot" name="product[{{$product_id}}][time_slot]"
                                            required>
