...
<table class="table table-condensed table-bordered table-striped table-responsive pos_table_{{$product_id}}"
    ...
    <tr>
        ...
        <th class="text-center pos_remove_table"><a onclick="pos_table_remove({{$product_id}})"><i class="fa fa-times text-danger pos_remove_row cursor-pointer" aria-hidden="true"></i></a></th>
    </tr>
    </thead>
    <tbody>
