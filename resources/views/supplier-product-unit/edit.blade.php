<div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      {{ Form::open(['url' => route('supplier-product-units.update',[$unit->id]), 'method' => 'patch', 'id' => 'edit_supplier_product_unit_form' ]) }}
        ...
        <div class="row">
          <div class="form-group col-sm-12">
            {{ Form::label('name', __( 'unit.name' ) . ':*') }}
              {{ Form::text('name', $unit->name, ['class' => 'form-control', 'required', 'placeholder' => __( 'unit.name' )]); }}
          </div>
