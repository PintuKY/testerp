...
@endif
    {{Form::open(['url'=>route('supplier-products.update' , [$supplier_product->id]), 'method'=>'patch','id'=>'supplier-product_form'])}}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                      {{ Form::select('supplier_id', $suppliers, $supplier_product->supplier_id, ['class' => 'form-control','style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'supplier_id']); }}
        ...
        <div class="row">
            <div class="col-12 col-md-6 ">
              ...
              <div class="form-group">
                  ...
                  {{ Form::text('purchase_price', $supplier_product->purchase_price, ['class' => 'form-control', 'required',
                  'placeholder' => __('product.product_name')]); }}
               </div>
            </div>
