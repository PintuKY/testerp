...
<section class="content-header">
    <h1> @lang('lang_v1.'.'suppliers')
        <small>@lang( 'supplier.manage_your_supplier', ['suppliers' =>  __('lang_v1.'.'suppliers') ])</small>
    </h1>
</section>
...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'supplier.all_your_supplier')])
            ...
            <table class="table table-bordered table-striped" id="supplier_table">
                ...
                <tfoot>
                    <tr class="bg-gray font-17 text-center footer-total">
                        ...
                        <td class="footer_supplier_due"></td>
                        <td class="footer_supplier_return_due"></td>
                    </tr>
                </tfoot>
            </table>
        @endif
    ...
    <div class="modal fade supplier_modal" tabindex="-1" role="dialog" 
...
<script type="text/javascript">
    $(document).on('shown.bs.modal', '.supplier_modal', function(e) {
        initAutocomplete();
    });
</script>
@endif
