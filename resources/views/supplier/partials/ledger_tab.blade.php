...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-9 text-right">
            <button data-href="{{action('SupplierController@getLedger')}}?supplier_id={{$supplier->id}}&action=pdf" class="btn btn-default btn-xs" id="print_ledger_pdf"><i class="fas fa-file-pdf"></i></button>

            <button type="button" class="btn btn-default btn-xs" id="send_ledger"><i class="fas fa-envelope"></i></button>
        </div>
    </div>
    <div id="supplier_ledger_div"></div>
</div>