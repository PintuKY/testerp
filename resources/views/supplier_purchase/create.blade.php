...
<section class="content">
	...
	{!! Form::open(['url' => action('SupplierPurchaseController@store'), 'method' => 'post', 'id' => 'add_supplier_purchase_form', 'files' => true ]) !!}
	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			...
			<div class="col-sm-2">
				<div class="form-group">
					<button tabindex="-1" type="button" class="btn btn-link btn-modal"data-href="{{action('SupplierProductController@quickAdd')}}" 
