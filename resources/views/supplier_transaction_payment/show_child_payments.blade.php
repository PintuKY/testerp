<table class="table table-condensed bg-gray">
  ...
  @forelse ($child_payments as $payment)
    <tr>
      ...
      @endif</td>
      <td class="no-print">
        <button type="button" class="btn btn-primary btn-xs view_payment" data-href="{{ action('SupplierTransactionPaymentController@viewPayment', [$payment->id]) }}" >@lang("messages.view")
                    </button>
      </td>
    </tr>
  @empty
